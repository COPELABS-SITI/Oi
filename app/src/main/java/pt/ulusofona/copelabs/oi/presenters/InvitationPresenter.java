...
import pt.ulusofona.copelabs.oi.interfaces.InvitationContract;
...
public class InvitationPresenter implements InvitationContract.Presenter {
    ...
    public InvitationPresenter(Context context, InvitationContract.View view, Contact contactRequester, Contact localContact) {
        mContext = context;
        mView = view;
        mView.showContactRequester(contactRequester.getName() + " " + mContext.getResources().getString(pt.ulusofona.copelabs.oi.R.string.new_invitation));
    ...
    public void actionUser(View view) {
        switch (view.getId()) {
            case pt.ulusofona.copelabs.oi.R.id.buttonAccept:
                ...
                mView.cancelDialog();
                break;
            case pt.ulusofona.copelabs.oi.R.id.buttonReject:
                mView.cancelDialog();
                break;
        }
