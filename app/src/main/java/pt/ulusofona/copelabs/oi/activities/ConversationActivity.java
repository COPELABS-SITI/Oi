...
import pt.ulusofona.copelabs.oi.adapters.MessageListAdapter;
import pt.ulusofona.copelabs.oi.interfaces.ConversationContract;
import pt.ulusofona.copelabs.oi.models.Message;
import pt.ulusofona.copelabs.oi.presenters.ConversationPresenter;
...
public class ConversationActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(pt.ulusofona.copelabs.oi.R.layout.activity_conversation);

        Log.d(TAG, "onCreate");

        mContactTextView = findViewById(pt.ulusofona.copelabs.oi.R.id.textView);

        mMessageRecycler = findViewById(pt.ulusofona.copelabs.oi.R.id.recyclerView);
        ...
        ImageButton btn = findViewById(pt.ulusofona.copelabs.oi.R.id.button);
        mContentEditText = findViewById(pt.ulusofona.copelabs.oi.R.id.editTextUserName);
