...
public class ReceivedMessageHolder extends RecyclerView.ViewHolder {
    ...
    public ReceivedMessageHolder(View itemView) {
        super(itemView);
        mContent = (TextView) itemView.findViewById(pt.ulusofona.copelabs.oi_ndn.R.id.textView);
        mTime = itemView.findViewById(pt.ulusofona.copelabs.oi_ndn.R.id.text_message_time);
    }
