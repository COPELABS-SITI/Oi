...
import pt.ulusofona.copelabs.oi_ndn.adapters.ContactsArrayAdapter;
...
import pt.ulusofona.copelabs.oi_ndn.presenters.ContactsPresenter;
...
public class NewChatDialogFragment extends DialogFragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(pt.ulusofona.copelabs.oi_ndn.R.layout.fragment_new_chat, container, false);

        mListView = v.findViewById(pt.ulusofona.copelabs.oi_ndn.R.id.listView_contacts);
        mListView.setOnItemClickListener(this);

        Button btnFinish = v.findViewById(pt.ulusofona.copelabs.oi_ndn.R.id.button3);
