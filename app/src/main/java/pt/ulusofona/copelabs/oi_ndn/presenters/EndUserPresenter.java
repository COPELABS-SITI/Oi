...
public class EndUserPresenter implements EndUserContract.Presenter, DataManager.PushData, DataManager.Invitations, ContactsLoader.ContactLoaderInterface {
    ...
    public void OnMenuItemPressed(int itemId) {
        switch (itemId) {
            case pt.ulusofona.copelabs.oi_ndn.R.id.user_configuration:
                mView.showUserConfiguration();
                break;
            case pt.ulusofona.copelabs.oi_ndn.R.id.emergency:
                mView.showEmergencyMessage();
                break;
            case pt.ulusofona.copelabs.oi_ndn.R.id.newChat:
                if (checkContactsPermission())
                    mView.showContact();
                break;
            case pt.ulusofona.copelabs.oi_ndn.R.id.messageConfiguration:
